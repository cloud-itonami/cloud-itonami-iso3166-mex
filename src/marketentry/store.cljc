(ns marketentry.store
  "SSoT for the MEX market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems MX" :portal "CompraNet"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-mx-entity? true :has-mx-entity? true
             :requires-rfc? true :rfc-verified? true
             :drafted? false :submitted? false
             :jurisdiction "MEX" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "CompraNet"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-mx-entity? true :has-mx-entity? true
             :requires-rfc? true :rfc-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "CompraNet"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "MEX" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "CompraNet"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-mx-entity? true :has-mx-entity? false
             :requires-rfc? true :rfc-verified? true
             :drafted? false :submitted? false
             :jurisdiction "MEX" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "CompraNet"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-mx-entity? true :has-mx-entity? true
             :requires-rfc? true :rfc-verified? false
             :drafted? false :submitted? false
             :jurisdiction "MEX" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "CompraNet"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-mx-entity? has-mx-entity?
                               requires-rfc? rfc-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-mx-entity?)  (assoc :engagement/requires-mx-entity? requires-mx-entity?)
    (some? has-mx-entity?)       (assoc :engagement/has-mx-entity? has-mx-entity?)
    (some? requires-rfc?)    (assoc :engagement/requires-rfc? requires-rfc?)
    (some? rfc-verified?)    (assoc :engagement/rfc-verified? rfc-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-mx-entity? :engagement/has-mx-entity?
   :engagement/requires-rfc? :engagement/rfc-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-mx-entity? (boolean (:engagement/requires-mx-entity? m))
     :has-mx-entity? (boolean (:engagement/has-mx-entity? m))
     :requires-rfc? (boolean (:engagement/requires-rfc? m))
     :rfc-verified? (boolean (:engagement/rfc-verified? m))
