# cloud-itonami-iso3166-mex

Open ISO 3166 Blueprint for **MEX**: Mexico.
...
tax registration, and local-content rules in Mexico, so the operator
...
- **Not the government of Mexico.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Mexican-licensed counsel
...
(ISO 3166 `MEX`). Required capabilities:
